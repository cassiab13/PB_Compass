...
def test_dividir_float(num1, num2, esperado):
    assert dividir(num1, num2) == esperado, "Teste da função dividir com números decimais"

@pytest.mark.parametrize("num1, num2, esperado", [(0, 3,0), (25, 5, 5), (35, -7, -5), (-42, -6, 7), (5,1,5)])
def test_dividir_inteiros(num1, num2, esperado):
    assert dividir(num1, num2) == esperado, "Teste da função dividir com números inteiros"
